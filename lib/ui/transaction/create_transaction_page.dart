...
class _CreateTransactionPageState extends ConsumerState<CreateTransactionPage> {
  ...
  void _handleSaveData() async {
    ...
    await controller.createOrUpdateTransaction(TransactionModel(
      ...
      amount: amount, type: _currentType, categoryId: _categoryId, transactionDate: _selectedDate, note: _noteInput.text,
    ));
    ...
    return Theme(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              Icon(hasValue ? _selectedCategory!.iconData : Icons.add_circle_outline, color: hasValue ? _selectedCategory!.color : Colors.red),
