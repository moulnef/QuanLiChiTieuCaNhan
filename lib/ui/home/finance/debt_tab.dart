    ...
    Future.microtask(() async {
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Đã thanh toán ${formatCurrency(amount)} cho "${item.title}"'),
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (value) {
                  ...
                  if (maxAmount != null && val > maxAmount) return 'Vượt quá số nợ còn lại';
                  return null;
                },
              ),
            ],
...
class _DebtCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color alertColor = (item.daysLeft < 0) ? Colors.redAccent : (item.daysLeft <= 7 ? Colors.orange : const Color(0xFF2563EB));
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              ...
              Container(
                ...
                child: Text(
                  item.interestText,
                  style: TextStyle(color: alertColor, fontWeight: FontWeight.w700, fontSize: 12),
                ),
              ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              _AmountColumn(label: 'Đã trả', amount: item.paidAmount, color: const Color(0xFF10B981)),
              _AmountColumn(label: 'Còn lại', amount: item.remainingAmount, color: Colors.redAccent, isRight: true),
            ],
          ),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              _TextInfoColumn(label: 'Trả mỗi tháng', value: formatCurrency(item.monthlyPayment)),
              _TextInfoColumn(label: 'Hạn tiếp theo', value: formatDate(item.dueDate), isRight: true, valueColor: alertColor),
            ],
          ),
...
class _TextInfoColumn extends StatelessWidget {
  ...
  const _TextInfoColumn({required this.label, required this.value, this.isRight = false, this.valueColor});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(
          value,
          style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: valueColor ?? const Color(0xFF475569)),
        ),
      ],
    );
  }
